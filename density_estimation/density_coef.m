...
pdf_smp = fun_pdf(smp_x_full(1:num_smp,:),par_loc_x,par_scale_x,par_corr_x);
...
sigmasimulation=weight_smp(smp_y(1:1e4,:),1./fun_pdf_smp(smp_x_full(1:1e4,:)).*fun_pdf(smp_x_full(1:1e4,:),par_loc_x,par_scale_x,par_corr_x),moment_obs_pool_y(moment_select),momentlist(moment_select,:));